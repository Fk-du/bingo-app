...
import { useNotificationsChannel } from '@/hooks/useNotifications';
...
export default function AppLayout({
  ...
  return (
    <div className="min-h-screen bg-bp-bg text-bp-text">
      ...
      {!isPlayer && (
        <aside
          className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-bp-border bg-bp-surface px-3 py-4 transition-transform duration-200 md:translate-x-0 ${
            ...
            <div className={`mx-auto flex max-w-lg items-center gap-3 px-4 py-3 ${isPlayer ? '' : 'max-w-[1440px] sm:px-6 lg:px-8'}`}>
              ...
              {isPlayer ? (
                <>
                  ...
                  <NotificationBell className="border-transparent bg-transparent" />
                  <Link
                    href="/player/profile"
